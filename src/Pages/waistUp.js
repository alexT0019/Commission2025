...
function getStaticImages() {
    ...
    const imageFiles = importAll(require.context('../Images/waist-up', false, /\.(png|jpe?g|svg)$/));
...
export default function WaistUp() {
    return(
        <div id="sectionContainer">
            ...
            <div id="infoContainer">
                <h1 style={{ color: `${colors.primary}` }}>Waist Up</h1>
                <ul>
                    <li class="infoText" style={{ color: `${colors.text}  ` }}>NTD. 800/US. 26 up</li>
